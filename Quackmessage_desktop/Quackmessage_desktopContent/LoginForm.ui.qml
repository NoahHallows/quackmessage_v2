...
//        enabled: usernameEdit.text.length > 0 && passwordEdit.text.length > 0
    ...
    states: [
        State {
            name: "initial"
            PropertyChanges {target: userNameLabel; enabled: false; opacity: 0; scale: 1.0}
            PropertyChanges {target: usernameEdit; enabled: false; opacity: 0; scale: 1.0}
            PropertyChanges {target: passwordEdit; enabled: false; opacity: 0; scale: 1.0}
            PropertyChanges {target: passwordLabel; enabled: false; opacity: 0; scale: 1.0}
            PropertyChanges {target: loginButton; enabled: false; opacity: 0; scale: 1.0}
            PropertyChanges {target: selectCreateUserButton; enabled: true; opacity: 1; scale: 1.0}
            PropertyChanges {target: selectLoginButton; enabled: true; opacity: 1; scale: 1.0}
